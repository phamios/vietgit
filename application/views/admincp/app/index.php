...
<div class="panel-heading" style="float:right;" > 
    <a href="<?php echo site_url('admincp/create_app'); ?>"   class="btn btn-info btn-danger" ><i class="fa fa-pencil"></i> Thêm mới</a>
</div>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                &nbsp;
                <a href="<?php echo site_url('admincp/app/1'); ?>" class="btn btn-primary">Ứng dụng</a>
                &nbsp;
                <a href="<?php echo site_url('admincp/app/2'); ?>" class="btn btn-primary">Games</a>
                &nbsp; 
                <p></p>
                <?php echo form_open_multipart('admincp/app'); ?>
