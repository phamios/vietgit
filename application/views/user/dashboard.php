...
<html lang="en">
    <head>
        ...
        <!-- start: CSS -->
        <link id="bootstrap-style" href="<?php echo base_url('src/user/css'); ?>/bootstrap.min.css" rel="stylesheet">
        <link href="<?php echo base_url('src/user/css'); ?>/bootstrap-responsive.min.css" rel="stylesheet">
        <link id="base-style" href="<?php echo base_url('src/user/css'); ?>/style.css" rel="stylesheet">
        <link id="base-style-responsive" href="<?php echo base_url('src/user/css'); ?>/style-responsive.css" rel="stylesheet">
        ...
        <!--[if lt IE 9]>
                ...
                <link id="ie-style" href="<?php echo base_url('src/user/css'); ?>/ie.css" rel="stylesheet">
        <![endif]-->

        <!--[if IE 9]>
                <link id="ie9style" href="<?php echo base_url('src/user/css'); ?>/ie9.css" rel="stylesheet">
        <![endif]-->

        <!-- start: Favicon -->
        <link rel="shortcut icon" href="<?php echo base_url('src/user/img'); ?>/favicon.ico">
        <!-- end: Favicon -->
